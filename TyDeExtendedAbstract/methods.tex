...
To implement the type-direcct algorithm, we follow the approach of \citet{Chapman2005}, who provide systematic approach to deriving an algorithm which supports type-directed rules by giving the type of the two normalized terms as an argument to the procedure deciding their equality.
...
Additionally, a \lstinline{Closure} representents a \lstinline{Env}.\todo{Not sure why a closure represent an env}
